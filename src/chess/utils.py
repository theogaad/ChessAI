...
def verify_type(obj_to_verify: object, type: type, function_name: str) -> None:
    if not isinstance(obj_to_verify, type):
        raise TypeError(f"{function_name} Le paramètre {obj_to_verify} doit être du type {type}.")
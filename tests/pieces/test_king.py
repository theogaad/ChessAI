...
def test_king_creation(piece_color: PieceColor) -> None:
...
def test_king_wrong_creation(piece_color) -> None:
...
def test_king_get_moves(white_king: King, start: tuple[int, int], expected_end_position: list[tuple[int, int]]) -> None:

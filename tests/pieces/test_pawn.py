...
def test_pawn_creation(piece_color: PieceColor) -> None:
...
def test_pawn_wrong_creation(piece_color) -> None:
...
@pytest.mark.parametrize("start, expected_end_position", [
    ...
    ((3, 7), [(4, 7), (4, 6), (5, 7)]),
    ((7, 7), [])])
def test_white_pawn_get_moves(white_pawn: Pawn, start: tuple[int, int], expected_end_position: list[tuple[int, int]]) -> None:
...
@pytest.mark.parametrize("start, expected_end_position", [
    ...
    ((3, 7), [(2, 7), (2, 6), (1, 7)]),
    ((7, 7), [(6, 7), (6, 6), (5, 7)])])
def test_black_pawn_get_moves(black_pawn: Pawn, start: tuple[int, int], expected_end_position: list[tuple[int, int]]) -> None:
...
def test_white_pawn_has_moved_get_moves(white_pawn: Pawn, start: tuple[int, int], expected_end_position: list[tuple[int, int]]) -> None:
...
@pytest.mark.parametrize("start, expected_end_position", [
    ...
    ((3, 7), [(2, 7), (2, 6)]),
    ((7, 7), [(6, 7), (6, 6)])])
def test_black_pawn_has_moved_get_moves(black_pawn: Pawn, start: tuple[int, int], expected_end_position: list[tuple[int, int]]) -> None:

...
def test_rook_creation(piece_color: PieceColor) -> None:
...
def test_rook_get_moves(white_rook: Rook, start: tuple[int, int], expected_end_position: list[tuple[int, int]]) -> None:

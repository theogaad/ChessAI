...
def test_bishop_wrong_creation(piece_color) -> None:
...
def test_bishop_get_moves(white_bishop: Bishop, start: tuple[int, int], expected_end_position: list[tuple[int, int]]) -> None:
